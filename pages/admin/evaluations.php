            ...
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <div class=" layout-top-spacing">
                        <nav class="breadcrumb-style-five  mb-3" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="managers.php">Evaluation</a></li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        ...
                        <a class="btn btn-primary" href="evaluation_summary.php">Evaluation Summary</a>
                ...
                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div>
                                    <p>Delete this Employee account? This process is non-reversible, and all records attached to this account ID will also be deleted. Do you want to proceed?</p><br>
                                </div>
