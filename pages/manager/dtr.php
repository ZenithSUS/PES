                    ...
                    <div class=" layout-top-spacing">
                        <nav class="breadcrumb-style-five  mb-3" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="managers.php">DTR</a></li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <tbody id="accountsTable">
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                while ($accounts = $result->fetch_assoc()) {
                                                    ...
                                                    $html .= '<td class="text-center"><span><img src="data:' . htmlspecialchars($accounts['imgType']) . ';base64,' . htmlspecialchars(base64_encode($accounts['img'])) . '" class="profile-img rounded-circle" alt="avatar"></span></td>';
                                                    ...
                                                    $html .= '<td class="text-center">
                                                                <ul class="table-controls">
                                                                    ...
                                                                    <li>
                                                                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"  data-id=' . htmlspecialchars($accounts['employee_id']) . '  data-bs-toggle="tooltip" data-bs-placement="top" title="Deactivate Account" data-original-title="Delete">Delete</a>
                                                                    </li>
                                                                </ul>
                                                            </td>';
                                                    $html .= '</tr>';
