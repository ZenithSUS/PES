...
<body class="layout-boxed">
    ...
    evaluationForm.addEventListener('submit', function(event) {
        ...
        alert(current_eval);
         ...
         insertMgrEvaluation(current_eval, evalRole, productivity, knowledge, quality, initiative, attitude, communication, creativity, rate_comment);
...
async function insertMgrEvaluation(fileName, evalRole, productivity, knowledge, quality, initiative, attitude, communication, creativity, rate_comment) {
