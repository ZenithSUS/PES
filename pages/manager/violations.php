                                ...
                                <div class="widget-content widget-content-area">
                                    <table id="style-3" class="table style-3 dt-table-hover">
                                        ...
                                        <tbody id="accountsTable">
                                            ...
                                            $sql = "SELECT CONCAT(accounts.first_name, ' ', accounts.middle_name, ' ', accounts.last_name) AS name, user_violations.*, hr_violation_list.*
                                                    FROM user_violations
                                                    LEFT JOIN hr_violation_list ON hr_violation_list.violation_id = user_violations.violation_id
                                                    LEFT JOIN accounts ON accounts.employee_id = user_violations.employee_id 
                                                    WHERE user_violations.department = '$department' AND user_violations.employee_id != '$user_id'";
