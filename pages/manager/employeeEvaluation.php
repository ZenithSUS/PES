...
<head>
    ...
    <title>PES | Employee Evaluation</title>
                    ...
                    <div class=" layout-top-spacing">
                        <nav class="breadcrumb-style-five  mb-3" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a>Employee ID : <?php echo $_GET['employee'] ?> </a></li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <table id="style-3" class="table style-3 dt-table-hover">
                                        ...
                                        <tbody id="accountsTable">
                                            ...
                                            $sql = "SELECT 
                                                            ...
                                                            a.img,
                                                            CASE 
                                                                WHEN e.evaluator_manager = '' THEN 'Please evaluate to download the file' 
                                                                ELSE 'Evaluated' 
                                                            END AS status
                                                        FROM 
                                                            evaluation e
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    $html .= '<tr>';
                                                    $html .= '<td class="text-center"><span><img src="../../api/' . htmlspecialchars(string: $row['img']) . '" class="profile-img rounded-circle" alt="avatar"></span></td>';
